...
3. Install azure-cosmos module `pip install azure-cosmos`
4. Install node modules `yarn install` or `npm install`.
5. Start development server `yarn start` or `npm start`.
...
* Cosmos DB - https://docs.microsoft.com/en-us/azure/cosmos-db/sql-api-sdk-python
